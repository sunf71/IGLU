...
#endif
#pragma warning(disable: 4002 4018 4024 4047 4048 4090 4146 4133 4244 4305 4996)
...
/* misc math functions */
const uint8_t* ff_get_sqrt_tab(void);
const uint8_t* ff_get_log2_tab(void);
const uint8_t* ff_get_reverse_tab(void);

static inline av_const int av_log2_c(unsigned int v)
{
    int n = 0;
    const uint8_t *log2_tab = ff_get_log2_tab();
    if (v & 0xffff0000) {
        v >>= 16;
        n += 16;
    }
