...
enum CodecID {
    ...
    CODEC_ID_WMA9,
    CODEC_ID_WMVP,  /* Windows Media Video 9 Image Codec  */
    CODEC_ID_WVP2,  /* Windows Media Video 9 Image Codec V2 */
    CODEC_ID_WMVA,  /* Windows Media Video 9 Advanced Profile */
    CODEC_ID_WMVR,  /* Unknown Video Codec supported by WMV DMO */
    CODEC_ID_MSS1,  /* Windows Media Screen version 7 */
    CODEC_ID_MSS2,  /* Windows Media Video 9 Screen */
    CODEC_ID_WMAVOICE2, /* Windows Media Audio 9 Voice codec V2 */

    CODEC_ID_DISCARD = 0x7FFFFFFF, /* Invalid codec, should be discarded */
};
...
/* 2M bytes for at least 1 second of 7.1 channels at 48khz 32bit audio */
...
#define CODEC_FLAG2_NO_ANNEXB     0x80000000 ///< H.264 place size (4 bytes) before NAL units
...
/* If 'parse_only' field is true, then av_parser_parse2() can be used. */
...
#define FF_ER_VERY_AGGRESSIVE 4
    ...
    int parse_only; /* - decoding only: If true, only parsing is done
                       (function av_parser_parse2()). The frame
