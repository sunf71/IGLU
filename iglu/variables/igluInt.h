...
public:
	IGLUInt();
	IGLUInt( int value, int _min=INT_MIN, int _max=INT_MAX, char *name=0 );
	IGLUInt( int value, const IGLURange<int> &range, int delta=1, char *name=0 );
	virtual ~IGLUInt() {}
	...
	void SetValue( int newValue, bool force = false );
